...
Request.get = Request.bind(this, 'GET');
Request.post = Request.bind(this, 'POST');
Request.put = Request.bind(this, 'PUT');
Request.delete = Request.bind(this, 'DELETE');
 ...
 * @return {string}
 */
Request.stringify = (obj, keyPrefix) => {
    let pairs = [];
    keyPrefix = keyPrefix || "";
    Object.keys(obj).forEach((key) => {
        ...
        if (Array.isArray(value)) {
            ...
            // Recurse
            let res = Request.stringify(value, getKey(key, keyPrefix));
