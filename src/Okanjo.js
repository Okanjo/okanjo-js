...
/**
 * Okanjo cookie helper
 * @type {{set: (function(*, *=, *)), get: (function(*))}}
 */
okanjo.util.cookie = Cookie;
...
okanjo.ui = {
    ...
    /**
     * okanjo template engine
     */
    engine: new TemplateEngine(okanjo),

    /**
     * Okanjo modal instance
     */
    modal: new Modal(okanjo),
