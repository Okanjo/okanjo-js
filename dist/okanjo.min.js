...
!function(e,t){"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?module.exports=t():e.okanjo=t()}(this,function(){var okanjo=okanjo||window.okanjo||function(){var e={metrics:{trackEvent:function(){},trackPageView:function(){}},moat:{insert:function(){}},routes:{products:"/products",products_id:"/products/:product_id",products_sense:"/products/sense"},getRoute:function(t,n){if(n)for(var i in n)n.hasOwnProperty(i)&&(t=t.replace(":"+i,n[i]+""));return e.config.ads.apiUri+t},exec:function(t,n,i){n=n||{},e.JSONP({url:t,data:n,error:function(t){var n={statusCode:500,error:"Communication Error",message:t.message||"JSONP communication failure."};e.report("core-jsonp",t.error||new Error(n.message)),i(n,null)},success:function(t){var n,r;t?t.error?n=t:r=t:(n={statusCode:500,error:"Invalid Response",message:"Could not interpret the JSONP response."},e.report("core-jsonp",new Error(n.message))),i(n,r)}})},report:function(e,t){var n;"string"==typeof t?n=new Error("[Okanjo"+(e?" "+e:"")+"] "+t):"object"==typeof t&&t instanceof Error&&(n=t),console.error(n)},util:{trim:function(e){return(e||"").replace(/^\s+|\s+$/g,"")},empty:function(t){return null===t||void 0===t||"string"==typeof t&&""===e.util.trim(t)},clone:function(e){var t={};e=e||{};for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);return t},hash:function(e){var t=0;if(0===e.length)return t;for(var n=0;n<e.length;n++){var i=e.charCodeAt(n);t=(t<<5)-t+i}return t.toString(16).replace(/^-/,"n")},data:function(e){var t={};if(e)for(var n=e.attributes,i=n.length-1;i>=0;i--)0===n[i].name.indexOf("data-")&&(t[n[i].name.substr(5)]=n[i].value);return t},copyIfSet:function(t,n,i,r,o){function s(r){!n||void 0===n[r]||o.stripEmpty&&e.util.empty(n[r])||(t[i]=n[r])}if(r=r||i,o=o||{},"object"==typeof r&&Array.isArray(r))for(var a=0;a<r.length;a++)s(r[a]);else s(r)},copyIfSetMap:function(t,n,i,r){for(var o=Object.keys(i),s=0;s<o.length;s++)e.util.copyIfSet(t,n,o[s],i[o[s]],r)},/*! https://github.com/isaacs/inherits/blob/master/inherits_browser.js */
