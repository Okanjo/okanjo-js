...
!function(e,t){"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?module.exports=t():e.okanjo=t()}(this,function(){var okanjo=okanjo||window.okanjo||function(e){function t(e){for(var t,n,i,o,r={},s=e.split("&"),a=0;a<s.length;a++)t=s[a],o=t.indexOf("="),0>o?(n=decodeURIComponent(t),i=null):(n=decodeURIComponent(t.substring(0,o)),i=decodeURIComponent(t.substring(o+1))),n&&(r[n]=i);return r}var n=void 0!==window.pageXOffset,i="CSS1Compat"===(document.compatMode||""),o=window.navigator.userAgent,r=function(){},s={qwery:r,metrics:{trackEvent:r,trackPageView:r},moat:{insert:r},routes:{products:"/products",products_id:"/products/:product_id",products_sense:"/products/sense",metrics:"/metrics/:object_type/:event_type"},getRoute:function(e,t){if(t)for(var n in t)t.hasOwnProperty(n)&&(e=e.replace(":"+n,t[n]+""));return s.config.ads.apiUri+e},exec:function(e,t,n){t=t||{},s.JSONP({url:e,data:t,error:function(e){var t={statusCode:500,error:"Communication Error",message:e.message||"JSONP communication failure."};s.report("core-jsonp",e.error||new Error(t.message)),n(t,null)},success:function(e){var t,i;e?e.error?t=e:i=e:(t={statusCode:500,error:"Invalid Response",message:"Could not interpret the JSONP response."},s.report("core-jsonp",new Error(t.message))),n(t,i)}})},report:function(e,t){var n;"string"==typeof t?n=new Error("[Okanjo"+(e?" "+e:"")+"] "+t):"object"==typeof t&&t instanceof Error&&(n=t),console.error(n)},util:{trim:function(e){return(e||"").replace(/^\s+|\s+$/g,"")},empty:function(e){return null===e||void 0===e||"string"==typeof e&&""===s.util.trim(e)},clone:function(e){var t={};e=e||{};for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);return t},hash:function(e){var t=0;if(0===e.length)return""+t;for(var n=0;n<e.length;n++){var i=e.charCodeAt(n);t=(t<<5)-t+i}return t.toString(16).replace(/^-/,"n")},data:function(e){var t={};if(e)for(var n=e.attributes,i=n.length-1;i>=0;i--)0===n[i].name.indexOf("data-")&&(t[n[i].name.substr(5)]=n[i].value);return t},copyIfSet:function(e,t,n,i,o){function r(i){!t||void 0===t[i]||o.stripEmpty&&s.util.empty(t[i])||(e[n]=t[i])}if(i=i||n,o=o||{},"object"==typeof i&&Array.isArray(i))for(var a=0;a<i.length;a++)r(i[a]);else r(i)},copyIfSetMap:function(e,t,n,i){for(var o=Object.keys(n),r=0;r<o.length;r++)s.util.copyIfSet(e,t,o[r],n[o[r]],i)},/*! https://github.com/isaacs/inherits/blob/master/inherits_browser.js */
inherits:function(e,t){if("function"==typeof Object.create)e.super_=t,e.prototype=Object.create(t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}});else{e.super_=t;var n=function(){};n.prototype=t.prototype,e.prototype=new n,e.prototype.constructor=e}},getScrollPosition:function(){return{x:n?window.pageXOffset:i?document.documentElement.scrollLeft:document.body.scrollLeft,y:n?window.pageYOffset:i?document.documentElement.scrollTop:document.body.scrollTop}},getElementSize:function(e,t){var n,i={height:e.offsetHeight,width:e.offsetWidth};return t&&(n=e.currentStyle||getComputedStyle(e),i.height+=parseInt(n.marginTop)+parseInt(n.marginBottom),i.width+=parseInt(n.marginLeft)+parseInt(n.marginRight)),i},getElementPosition:function(e){var t=e.getBoundingClientRect(),n=s.util.getScrollPosition();return{x1:t.left+n.x,y1:t.top+n.y,x2:t.right+n.x,y2:t.bottom+n.y}},getPageSize:function(){var e=s.qwery("body")[0],t=document.documentElement;return{w:Math.max(e.scrollWidth,e.offsetWidth,t.clientWidth,t.scrollWidth,t.offsetWidth),h:Math.max(e.scrollHeight,e.offsetHeight,t.clientHeight,t.scrollHeight,t.offsetHeight)}},getViewportSize:function(){return{vw:Math.max(document.documentElement.clientWidth,window.innerWidth||0),vh:Math.max(document.documentElement.clientHeight,window.innerHeight||0)}},ellipsify:function(e,t){for(var n=t||e.parentNode,i=s.util.getElementSize(n).height,o=void 0!==e.textContent,r=o?e.textContent:e.innerText,a="",c=5e3,u=function(e){return a=e.substr(0,e.length-3)+a,"..."};s.util.getElementSize(e).height>i&&r.length>0&&c-->0;)r=o?e.textContent:e.innerText,r=r.replace(/[\s\S](?:\.\.\.)?$/,u),o?e.textContent=r:e.innerText=r;if(a.length>0){var l=document.createElement("span"),d=document.createElement("span");l.setAttribute("class","okanjo-ellipses"),d.setAttribute("class","okanjo-visually-hidden"),o?(l.textContent=r.substr(0,r.length-3),d.textContent=a):(l.innerText=r.substr(0,r.length-3),d.innerText=a),e.innerHTML="",e.appendChild(l),e.appendChild(d)}},detectClasses:function(){var e=[];return-1!=navigator.appVersion.indexOf("MSIE 9.")?e.push("lt-ie10"):-1!=navigator.appVersion.indexOf("MSIE 8.")?e.push("lt-ie9"):-1!=navigator.appVersion.indexOf("MSIE 7.")?e.push("lt-ie8"):-1!=navigator.appVersion.indexOf("MSIE 6.")&&e.push("lt-ie7"),e},isFramed:function(){return window.top!==window.self},isiOS:function(){return/(iPhone|iPad|iPod)/i.test(o)},isAndroid:function(){return/Android/.test(o)},isMobile:function(){return s.util.isiOS()||s.util.isAndroid()},getPageArguments:function(e){var n=t(window.location.search.substring(window.location.search.indexOf("?")+1));if(e){var i=t(window.location.hash.substring(Math.max(window.location.hash.indexOf("#")+1,window.location.hash.indexOf("#!")+2)));for(var o in i)i.hasOwnProperty(o)&&(n[o]=i[o])}return n},deepClone:function(e,t){var n,i=0;if(Array.isArray(e))for(t=t||[];i<e.length;i++)t.push(s.util.deepClone(e[i]));else if("object"==typeof e){t=t||{};for(n in e)e.hasOwnProperty(n)&&(t[n]=s.util.deepClone(e[n]))}else t=e;return t}}};if(e){for(var a in s)e.hasOwnProperty(a)||(e[a]=s[a]);return e}return s}(okanjo||window.okanjo);/*! Console-polyfill. | MIT license. | https://github.com/paulmillr/console-polyfill */
