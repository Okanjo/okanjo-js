/*! okanjo-js v1.10.2 | (c) 2013 Okanjo Partners Inc | https://okanjo.com/ */
...
(function (window) {
    ...
    okanjo.ui.engine.registerTemplate("okanjo.error", "<span class=okanjo-error>{{ message }}</span><img src=\"//cdn.okanjo.com/px/0.gif?n={{ now }}\"> {{#code}} <span class=okanjo-error-code>Reference: {{ code }}</span> {{/code}}", { css: ['okanjo.core'] });
})(window);
(function (window) {
