...
/*! okanjo-js v0.3.8 | (c) 2013 Okanjo Partners Inc | https://okanjo.com/ */
!function(e,t){"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?module.exports=t():e.okanjo=t()}(this,function(){var okanjo=okanjo||window.okanjo||function(e){var t={metrics:{trackEvent:function(){},trackPageView:function(){}},moat:{insert:function(){}},routes:{products:"/products",products_id:"/products/:product_id",products_sense:"/products/sense"},getRoute:function(e,n){if(n)for(var o in n)n.hasOwnProperty(o)&&(e=e.replace(":"+o,n[o]+""));return t.config.ads.apiUri+e},exec:function(e,n,o){n=n||{},t.JSONP({url:e,data:n,error:function(e){var n={statusCode:500,error:"Communication Error",message:e.message||"JSONP communication failure."};t.report("core-jsonp",e.error||new Error(n.message)),o(n,null)},success:function(e){var n,i;e?e.error?n=e:i=e:(n={statusCode:500,error:"Invalid Response",message:"Could not interpret the JSONP response."},t.report("core-jsonp",new Error(n.message))),o(n,i)}})},report:function(e,t){var n;"string"==typeof t?n=new Error("[Okanjo"+(e?" "+e:"")+"] "+t):"object"==typeof t&&t instanceof Error&&(n=t),console.error(n)},util:{trim:function(e){return(e||"").replace(/^\s+|\s+$/g,"")},empty:function(e){return null===e||void 0===e||"string"==typeof e&&""===t.util.trim(e)},clone:function(e){var t={};e=e||{};for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);return t},hash:function(e){var t=0;if(0===e.length)return t;for(var n=0;n<e.length;n++){var o=e.charCodeAt(n);t=(t<<5)-t+o}return t.toString(16).replace(/^-/,"n")},data:function(e){var t={};if(e)for(var n=e.attributes,o=n.length-1;o>=0;o--)0===n[o].name.indexOf("data-")&&(t[n[o].name.substr(5)]=n[o].value);return t},copyIfSet:function(e,n,o,i,r){function a(i){!n||void 0===n[i]||r.stripEmpty&&t.util.empty(n[i])||(e[o]=n[i])}if(i=i||o,r=r||{},"object"==typeof i&&Array.isArray(i))for(var s=0;s<i.length;s++)a(i[s]);else a(i)},copyIfSetMap:function(e,n,o,i){for(var r=Object.keys(o),a=0;a<r.length;a++)t.util.copyIfSet(e,n,r[a],o[r[a]],i)},/*! https://github.com/isaacs/inherits/blob/master/inherits_browser.js */
