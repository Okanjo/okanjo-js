...
/*! okanjo-js v0.5.2 | (c) 2013 Okanjo Partners Inc | https://okanjo.com/ */
!function(e,t){"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?module.exports=t():e.okanjo=t()}(this,function(){var okanjo=okanjo||window.okanjo||function(e){function t(e){for(var t,o,n,i,r={},a=e.split("&"),s=0;s<a.length;s++)t=a[s],i=t.indexOf("="),0>i?(o=decodeURIComponent(t),n=null):(o=decodeURIComponent(t.substring(0,i)),n=decodeURIComponent(t.substring(i+1))),o&&(r[o]=n);return r}var o=void 0!==window.pageXOffset,n="CSS1Compat"===(document.compatMode||""),i=window.navigator.userAgent,r=function(){},a={qwery:r,metrics:{trackEvent:r,trackPageView:r},moat:{insert:r},routes:{products:"/products",products_id:"/products/:product_id",products_sense:"/products/sense",metrics:"/metrics/:object_type/:event_type"},getRoute:function(e,t){if(t)for(var o in t)t.hasOwnProperty(o)&&(e=e.replace(":"+o,t[o]+""));return a.config.ads.apiUri+e},exec:function(e,t,o){t=t||{},a.JSONP({url:e,data:t,error:function(e){var t={statusCode:500,error:"Communication Error",message:e.message||"JSONP communication failure."};a.report("core-jsonp",e.error||new Error(t.message)),o(t,null)},success:function(e){var t,n;e?e.error?t=e:n=e:(t={statusCode:500,error:"Invalid Response",message:"Could not interpret the JSONP response."},a.report("core-jsonp",new Error(t.message))),o(t,n)}})},report:function(e,t){var o;"string"==typeof t?o=new Error("[Okanjo"+(e?" "+e:"")+"] "+t):"object"==typeof t&&t instanceof Error&&(o=t),console.error(o)},util:{trim:function(e){return(e||"").replace(/^\s+|\s+$/g,"")},empty:function(e){return null===e||void 0===e||"string"==typeof e&&""===a.util.trim(e)},clone:function(e){var t={};e=e||{};for(var o in e)e.hasOwnProperty(o)&&(t[o]=e[o]);return t},hash:function(e){var t=0;if(0===e.length)return""+t;for(var o=0;o<e.length;o++){var n=e.charCodeAt(o);t=(t<<5)-t+n}return t.toString(16).replace(/^-/,"n")},data:function(e){var t={};if(e)for(var o=e.attributes,n=o.length-1;n>=0;n--)0===o[n].name.indexOf("data-")&&(t[o[n].name.substr(5)]=o[n].value);return t},copyIfSet:function(e,t,o,n,i){function r(n){!t||void 0===t[n]||i.stripEmpty&&a.util.empty(t[n])||(e[o]=t[n])}if(n=n||o,i=i||{},"object"==typeof n&&Array.isArray(n))for(var s=0;s<n.length;s++)r(n[s]);else r(n)},copyIfSetMap:function(e,t,o,n){for(var i=Object.keys(o),r=0;r<i.length;r++)a.util.copyIfSet(e,t,i[r],o[i[r]],n)},/*! https://github.com/isaacs/inherits/blob/master/inherits_browser.js */
inherits:function(e,t){if("function"==typeof Object.create)e.super_=t,e.prototype=Object.create(t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}});else{e.super_=t;var o=function(){};o.prototype=t.prototype,e.prototype=new o,e.prototype.constructor=e}},getScrollPosition:function(){return{x:o?window.pageXOffset:n?document.documentElement.scrollLeft:document.body.scrollLeft,y:o?window.pageYOffset:n?document.documentElement.scrollTop:document.body.scrollTop}},getElementSize:function(e,t){var o,n={height:e.offsetHeight,width:e.offsetWidth};return t&&(o=e.currentStyle||getComputedStyle(e),n.height+=parseInt(o.marginTop)+parseInt(o.marginBottom),n.width+=parseInt(o.marginLeft)+parseInt(o.marginRight)),n},getElementPosition:function(e){var t=e.getBoundingClientRect(),o=a.util.getScrollPosition();return{x1:t.left+o.x,y1:t.top+o.y,x2:t.right+o.x,y2:t.bottom+o.y}},getPageSize:function(){var e=a.qwery("body")[0],t=document.documentElement;return{w:Math.max(e.scrollWidth,e.offsetWidth,t.clientWidth,t.scrollWidth,t.offsetWidth),h:Math.max(e.scrollHeight,e.offsetHeight,t.clientHeight,t.scrollHeight,t.offsetHeight)}},getViewportSize:function(){return{vw:Math.max(document.documentElement.clientWidth,window.innerWidth||0),vh:Math.max(document.documentElement.clientHeight,window.innerHeight||0)}},ellipsify:function(e,t){for(var o=t||e.parentNode,n=a.util.getElementSize(o).height,i=void 0!==e.textContent,r=i?e.textContent:e.innerText,s="",c=5e3,l=function(e){return s=e.substr(0,e.length-3)+s,"..."};a.util.getElementSize(e).height>n&&r.length>0&&c-->0;)r=i?e.textContent:e.innerText,r=r.replace(/[\s\S](?:\.\.\.)?$/,l),i?e.textContent=r:e.innerText=r;if(s.length>0){var d=document.createElement("span"),u=document.createElement("span");d.setAttribute("class","okanjo-ellipses"),u.setAttribute("class","okanjo-visually-hidden"),i?(d.textContent=r.substr(0,r.length-3),u.textContent=s):(d.innerText=r.substr(0,r.length-3),u.innerText=s),e.innerHTML="",e.appendChild(d),e.appendChild(u)}},detectClasses:function(){var e=[];return-1!=navigator.appVersion.indexOf("MSIE 9.")?e.push("lt-ie10"):-1!=navigator.appVersion.indexOf("MSIE 8.")?e.push("lt-ie9"):-1!=navigator.appVersion.indexOf("MSIE 7.")?e.push("lt-ie8"):-1!=navigator.appVersion.indexOf("MSIE 6.")&&e.push("lt-ie7"),e},isFramed:function(){return window.top!==window.self},isiOS:function(){return/(iPhone|iPad|iPod)/i.test(i)},isAndroid:function(){return/Android/.test(i)},isMobile:function(){return a.util.isiOS()||a.util.isAndroid()},getPageArguments:function(e){var o=t(window.location.search.substring(window.location.search.indexOf("?")+1));if(e){var n=t(window.location.hash.substring(Math.max(window.location.hash.indexOf("#")+1,window.location.hash.indexOf("#!")+2)));for(var i in n)n.hasOwnProperty(i)&&(o[i]=n[i])}return o},deepClone:function(e,t){var o,n=0;if(Array.isArray(e))for(t=t||[];n<e.length;n++)t.push(a.util.deepClone(e[n]));else if("object"==typeof e){t=t||{};for(o in e)e.hasOwnProperty(o)&&(t[o]=a.util.deepClone(e[o]))}else t=e;return t}}};if(e){for(var s in a)e.hasOwnProperty(s)||(e[s]=a[s]);return e}return a}(okanjo||window.okanjo);/*! Console-polyfill. | MIT license. | https://github.com/paulmillr/console-polyfill */
